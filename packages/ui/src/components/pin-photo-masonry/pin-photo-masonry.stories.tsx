...
import { PinPhotoMasonry } from "./pin-photo-masonry";
...
const meta = {
  title: "Pin Photo Masonry",
  ...componentStoryMeta(
    "Masonry photo grid for pin detail with hover affordance and optional source links.",
    "Pass signed URLs and optional plugin icon links to original product pages.",
  ),
  component: PinPhotoMasonry,
  args: {
    items: [...sampleItems],
    onOpen: () => undefined,
  },
} satisfies Meta<typeof PinPhotoMasonry>;
