...
import styles from "./pin-photo-masonry.module.css";

export type PinPhotoMasonryItem = {
  id: string;
  url: string;
  alt?: string;
...
export const pinPhotoMasonryStyles = styles;
